...
namespace Week2_IdentitySystem.Data
{
    public static class DbInitializer
    {
        ...
        private static async Task<int> SeedUsers(UserManager<ApplicationUser> userManager)
        {
            ...
            // Assign user claim to Admin user
            result = await userManager.AddClaimAsync(adminUser, 
            ...
            // Assign user claim to Member user
            result = await userManager.AddClaimAsync(memberUser, 
